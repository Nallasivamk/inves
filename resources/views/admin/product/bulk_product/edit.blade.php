			...
			<div class="col-8">
			  <div class="card">
				<div class="card-header bg-color">
				  <h4 class="card-title">Bulk Product</h4>
				</div>
				{!! Form::model($usersInfo,['url' => url('admin/manage_bulk_product/bulk_product/update'),'id'=>'editBulkProduct','enctype'=>"multipart/form-data"]) !!}
					<?php $edit = 'edit'; ?>
					<input type="hidden" name="id" value="{{ App\Http\Helper\Admin\Helpers::encodeAndDecodeID($usersInfo->id,'encode') }}" />
					@include('admin.product.bulk_product.form')
				{!! Form::close() !!}
			  </div>
			</div>
			<div class="col-2"></div>
