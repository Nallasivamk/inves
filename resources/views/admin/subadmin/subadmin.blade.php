							   ...
							   <div class="heading-elements">
								  <div id="heading5" class="card bg-fliter-color" data-toggle="collapse" data-target="#accordion5" aria-expanded="false"
									 aria-controls="accordion5" role="tablist">
										@if(App\Http\Helper\Admin\Helpers::checkModulePermission('Manage_Admin','Admin_user','Add'))
									 		<a href="{{ url('admin/manage-admin/admin-user/create') }}" class="text-right"><i class='bx bx-plus-circle size bx-fade' ></i>New User</a>
										@endif
								  </div>
							   </div>
							</div>
								...
								<div class="table-responsive">
									<table class="table table-bordered" id="myTable">
										<thead>
											...
											<th>Role</th>
											<th>Status</th>
											@if(App\Http\Helper\Admin\Helpers::checkModulePermission('Manage_Admin','Admin_user','Update') || App\Http\Helper\Admin\Helpers::checkModulePermission('Manage_Admin','Admin_user','Delete'))
												<th>ACTION</th>
											@endif
											</tr>
										</thead>
										...
										@foreach($usersInfo as $list)
											<tr>
												...
												@if(App\Http\Helper\Admin\Helpers::checkModulePermission('Manage_Admin','Admin_user','Update') || App\Http\Helper\Admin\Helpers::checkModulePermission('Manage_Admin','Admin_user','Delete'))
													...
													@if(App\Http\Helper\Admin\Helpers::checkModulePermission('Manage_Admin','Admin_user','Update'))
														<a href="{{ url('admin/manage-admin/admin-user/'.$id.'/edit') }}"><i
														class="badge-circle badge-circle-light-secondary bx bx-edit font-medium-1"></i>
														</a>
													@endif
													@if(App\Http\Helper\Admin\Helpers::checkModulePermission('Manage_Admin','Admin_user','Delete'))
														<a href="#"><i
