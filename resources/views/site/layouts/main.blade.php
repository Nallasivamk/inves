...
<html>
<head>
      @php $siteInfo = App\Http\Helper\Admin\Helpers::siteSetting(); @endphp
    <meta http-equiv="content-type" content="text/html;charset=UTF-8" />
    <link rel="icon" href="{{ asset('images') }}\uploads\favicon\{{ $siteInfo['setting']->favicon }}" type="image/gif" sizes="16x16">
    <meta charset="utf-8">
...
<header class="header-area header-style-1 header-height-2 header-style-5">
    @include('site.layouts.miniheader')
    @include('site.layouts.header')
    @include('site.layouts.menubar')
</header>
