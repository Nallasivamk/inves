...
<script src="{{asset('themes/nest/js/backendfe21.js')}}" ></script>
<script src="{{asset('themes/nest/js/componentsfe21.js')}}" ></script>
<script src="{{asset('themes/nest/js/mainfe21.js')}}" ></script>
<script src="{{asset('vendor/core/plugins/ecommerce/js/change-product-swatchesfe21.js')}}" ></script>
<script src="{{asset('vendor/core/plugins/cookie-consent/js/cookie-consente209.js')}}" ></script>
