         ...
         <div class="col-lg-4-5">
            <div class="col-lg-12">
               <div class="table-responsive shopping-summery">
                  <table class="table table-wishlist table--cart">
                     <thead>
                        <tr class="main-heading">
                           <th scope="col" colspan="2" class="start pl-30">Bulk Product</th>
                           <th></th>
                     ...
                     @foreach($bulkproductInfo as $list)
                        ...
                        <td class="image product-thumbnail pt-10" style="width:12% !important">
                           ...
                           <td class="product-des product-name">
                              <h6 class="mb-1"><a href="https://nest.botble.com/products/foster-farms-takeout-crispy-classic" class="product-name mb-1 text-heading">{{ $list->bulk_product_name }}</a></h6>
                           ...
                           <td data-title="Price" class="price">
                              <h4 class="text-body">$ {{ number_format($list->invest_amount,2) }} </h4>                              
                           </td>
                           
                           <td data-title="Price" class="price">
                              <h4 class="text-body">$ {{ number_format($list->return_amount,2) }} </h4>                              
                           </td>
                           
                           <td data-title="Price" class="price">
                              <h4 class="text-brand">${{ number_format(((double)$list->return_amount - (double)$list->invest_amount),2) }}  </h4>
                           </td>
                  ...
                  <!--a href="#" class="load_mins_more">yy more</a-->
               </div>
...
<!---
               <div class="table-responsive shopping-summery">
                  <table class="table table-wishlist table--cart">
                     <thead>
                        <tr class="main-heading">
                           <th scope="col" colspan="2" class="start pl-30">Bluk Product</th>
                           <th></th>
...
<script>
   ...
   $('table tr:first,tr:eq(1),tr:eq(2),tr:eq(3)').addClass('active');
...
$('a.load_more').on('click', function(e) {
  ...
  var lastActiveIndex = $rows.filter('.active:last').index();console.log(lastActiveIndex)
