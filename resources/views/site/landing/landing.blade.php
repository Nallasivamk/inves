                     ...
                     <div class="product-cart-wrap mb-30">
                        ...
                        @foreach($list as $innerlist)
                           @if($count < 2)
                              ...
                              <h6 class="pl-10 pt-10"><a href="products/naturally-flavored-cinnamon-vanilla-light-roast-coffee.html">{{ $innerlist['item_name'] }}</a></h6>
                                 <div>
                                    <div class="product-img-action-wrap">
                                       <div class="product-img product-img-zoom">
                                          <?php $url = url('/product_details')."/".App\Http\Helper\Admin\Helpers::encodeAndDecodeID($innerlist['order_number'],'encode');  ?>
                                          <a href="{{ url('/product_details/') }}/{{ App\Http\Helper\Admin\Helpers::encodeAndDecodeID($innerlist['order_number'],'encode') }}">
                        ...
                        <h6 class="pl-10 pt-10"><a href="{{ $url }}">More Details</a></h6>
