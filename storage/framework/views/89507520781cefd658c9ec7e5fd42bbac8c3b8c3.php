...
<main id="main-section" class="main">
         ...
         <div class="tab-style3">
            <ul class="nav nav-tabs text-uppercase">
               ...
               <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li class="nav-item"><a id="Description-tab" data-bs-toggle="tab" href="#product<?php echo e($labelCount); ?>" class="nav-link <?php if($labelCount == 1): ?> active <?php endif; ?>">Product <?php echo e($labelCount); ?></a></li>
               <?php $labelCount++; ?>
    ...
    <div class="container mb-30">
      <div class="tab-content shop_info_tab entry-main-content">
         ...
         <?php $descCount = 1; ?>
         <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
         <div id="product<?php echo e($descCount); ?>" class="tab-pane fade show active">
...
<?php echo $__env->make('site.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/invesment/resources/views/site/product/product_detail.blade.php ENDPATH**/ ?>