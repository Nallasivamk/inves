								  ...
								  <div id="heading5" class="card bg-fliter-color" data-toggle="collapse" data-target="#accordion5" aria-expanded="false"
									 aria-controls="accordion5" role="tablist">
										<?php if(App\Http\Helper\Admin\Helpers::checkModulePermission('Manage_Admin','Admin_user','Add')): ?>
									 		<a href="<?php echo e(url('admin/manage-admin/admin-user/create')); ?>" class="text-right"><i class='bx bx-plus-circle size bx-fade' ></i>New User</a>
										<?php endif; ?>
								  </div>
							   </div>
							</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.main.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/joshith/Workspace/Trivizion/Outsourcing/invesment/resources/views/admin/subadmin/subadmin.blade.php ENDPATH**/ ?>