      ...
      <div class="navbar-collapse" id="navbar-mobile">
        ...
        <ul class="nav navbar-nav float-right">
              ...
              <li class="scrollable-container media-list"><a class="d-flex justify-content-between" href="javascript:void(0)">
                  <div class="media d-flex align-items-center">
                    <div class="media-left pr-0">
                      <div class="avatar mr-1 m-0"><img src="<?php echo e(asset('images/admin/images/portrait/small/avatar-s-11.jpg')); ?>" alt="avatar" height="39" width="39"></div>
                    </div>
                ...
                <div class="d-flex justify-content-between read-notification cursor-pointer">
                  <div class="media d-flex align-items-center">
                    <div class="media-left pr-0">
                      <div class="avatar mr-1 m-0"><img src="<?php echo e(asset('images/admin/images/portrait/small/avatar-s-16.jpg')); ?>" alt="avatar" height="39" width="39"></div>
                    </div>
                    <div class="media-body">
                ...
                <div class="d-flex justify-content-between cursor-pointer">
                  <div class="media d-flex align-items-center py-0">
                    <div class="media-left pr-0"><img class="mr-1" src="<?php echo e(asset('images/admin/images/icon/sketch-mac-icon.png')); ?>" alt="avatar" height="39" width="39"></div>
                    <div class="media-body">
                ...
                <div class="d-flex justify-content-between read-notification cursor-pointer">
                  <div class="media d-flex align-items-center">
                    <div class="media-left pr-0">
                      <div class="avatar mr-1 m-0"><img src="<?php echo e(asset('images/admin/images/portrait/small/avatar-s-4.jpg')); ?>" alt="avatar" height="39" width="39"></div>
                    </div>
                    <div class="media-body">
          ...
          <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
              <div class="user-nav d-sm-flex d-none"><span class="user-name"><?php echo e(Auth::user()->name); ?></span><span class="user-status text-muted">Online</span></div><span><img class="round" src="<?php echo e(asset('images/admin/images/portrait/small/avatar-s-11.jpg')); ?>" alt="avatar" height="40" width="40"></span></a>
            <div class="dropdown-menu dropdown-menu-right pb-0"><a class="dropdown-item" href="page-user-profile.html"><i class="bx bx-user mr-50"></i> Edit Profile</a><a class="dropdown-item" href="app-email.html"><i class="bx bx-envelope mr-50"></i> My Inbox</a><a class="dropdown-item" href="app-todo.html"><i class="bx bx-check-square mr-50"></i> Task</a><a class="dropdown-item" href="app-chat.html"><i class="bx bx-message mr-50"></i> Chats</a>
              ...
              <div class="dropdown-divider mb-0"></div>
				<a class="dropdown-item" href="<?php echo e(url('admin/logout')); ?>"><i class="bx bx-power-off mr-50"></i> Logout</a>
            </div>
          </li>
        </ul>
      </div>
...
<!-- END: Header--><?php /**PATH /media/joshith/Workspace/Trivizion/Outsourcing/invesment/resources/views/admin/layouts/header.blade.php ENDPATH**/ ?>