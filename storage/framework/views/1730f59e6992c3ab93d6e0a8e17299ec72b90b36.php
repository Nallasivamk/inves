               ...
               <div class="col-lg-6 col-md-8">
                  <div class="login_wrap widget-taber-content background-white">
                     <div class="padding_eight_all bg-white">
                        ...
                        <form method="POST" action="<?php echo e(url('/login')); ?>" id="login">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('site.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel/invesment/resources/views/site/auth/login.blade.php ENDPATH**/ ?>