				...
				<div class="col-12">
					<div class="card">
						<div class="card-header bg-color">
							 <div class="row">
								<h5 class="card-title ">Static Page</h5>
						...
						<div class="card-content">
							...
							<section id="accordion-icon-wrapper">
							   <div class="accordion collapse-icon accordion-icon-rotate" id="accordionWrapa2">
								...
								<div class="col-lg-12">
								   <a href="<?php echo e(url('admin/manage-staticPage/page/create')); ?>" class="text-right"><i class='bx bx-plus-circle size bx-fade' ></i>New Page</a>
								</div>
								<div class="table-responsive">
									<table class="table table-fit table-bordered" id="staticPageTable" style="width:100% !important">
										<thead>
											<tr>
												<th>Page Name</th>
												<th>Status</th>
...
$(function(){
   	...
   	var table = $('#staticPageTable').DataTable({
   		...
   		pageLength: 50,
   		ajax:{
   			url: "<?php echo e(url('admin/manage-staticPage/indexData')); ?>",
   			data: function (d) {
                   d.test = 'testse'
               }
   		},
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.main.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Trivizion\Outsourcing\invesment\resources\views/admin/site/page/page.blade.php ENDPATH**/ ?>