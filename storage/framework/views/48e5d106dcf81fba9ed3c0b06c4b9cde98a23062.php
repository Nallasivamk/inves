            ...
            <div class="container">
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4 col-12 col-sm-6">
                    <div class="product-cart-wrap mb-30">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                            <a href="products/all-natural-italian-style-chicken-meatballs.html">
                            <img class="default-img" src="<?php echo e(asset('images/products/2-400x400.jpg')); ?>" alt="All Natural Italian-Style Chicken Meatballs">
                            <img class="hover-img" src="<?php echo e(asset('images/products/2-1-400x400.jpg')); ?>" alt="All Natural Italian-Style Chicken Meatballs">
                            </a>
                            </div>
                            
                            <div class="product-badges product-badges-position product-badges-mrg">
                            <span class="hot">-49%</span>
                            </div>
                        </div>
                        <div class="product-content-wrap">
                            <div class="product-category">
                            <a href="product-categories/vegetables.html">Vegetables</a>
                            </div>
                            <h2><a href="products/all-natural-italian-style-chicken-meatballs.html">All Natural Italian-Style Chicken Meatballs</a></h2>
                            <div class="product-rate-cover">
                            <div class="product-rate d-inline-block">
                                <div class="product-rating" style="width: 85.714285714286%"></div>
                            </div>
                            <span class="font-small ml-5 text-muted">(7)</span>
                            </div>
                            <div>
                            ...
                            <div class="product-price">
                                <span>5,490,758₫</span>
                                <span class="old-price">10,766,192₫</span>
                            </div>
                            <div class="add-cart">
                                <a aria-label="Add To Cart" class="action-btn add-to-cart-button add" data-id="2" data-url="https://nest.botble.com/cart/add-to-cart" href="#">
                                <i class="fi-rs-shopping-cart mr-5"></i> <span class="d-inline-block">Add</span>
                                </a>
                            </div>
                            </div>
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4 col-12 col-sm-6">
                    <div class="product-cart-wrap mb-30">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                            <a href="products/chobani-complete-vanilla-greek.html">
                            <img class="default-img" src="<?php echo e(asset('images/products/6-400x400.jpg')); ?>" alt="Chobani Complete Vanilla Greek">
                            <img class="hover-img" src="<?php echo e(asset('images/products/6-1-400x400.jpg')); ?>" alt="Chobani Complete Vanilla Greek">
                            </a>
                            </div>
                        ...
                        <div class="product-content-wrap">
                            ...
                            <h2><a href="products/chobani-complete-vanilla-greek.html">Chobani Complete Vanilla Greek</a></h2>
                            <div class="product-rate-cover">
                            <div class="product-rate d-inline-block">
                            ...
                            <div class="product-price">
                                <span>580,075₫</span>
                                <span class="old-price">1,160,150₫</span>
                            </div>
                            <div class="add-cart">
                                <a aria-label="Add To Cart" class="action-btn add-to-cart-button add" data-id="6" data-url="https://nest.botble.com/cart/add-to-cart" href="#">
                                <i class="fi-rs-shopping-cart mr-5"></i> <span class="d-inline-block">Add</span>
                                </a>
                            </div>
                            </div>
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4 col-12 col-sm-6">
                    <div class="product-cart-wrap mb-30">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                            <a href="products/canada-dry-ginger-ale-2-l-bottle.html">
                            <img class="default-img" src="<?php echo e(asset('images/products/7-400x400.jpg')); ?>" alt="Canada Dry Ginger Ale – 2 L Bottle">
                            <img class="hover-img" src="<?php echo e(asset('images/products/7-1-400x400.jpg')); ?>" alt="Canada Dry Ginger Ale – 2 L Bottle">
                            </a>
                            </div>
                        ...
                        <div class="product-content-wrap">
                            <div class="product-category">
                            <a href="product-categories/coffee-teas.html">Coffee &amp; Teas</a>
                            </div>
                            <h2><a href="products/canada-dry-ginger-ale-2-l-bottle.html">Canada Dry Ginger Ale – 2 L Bottle</a></h2>
                            <div class="product-rate-cover">
                            <div class="product-rate d-inline-block">
                                <div class="product-rating" style="width: 56.666666666667%"></div>
                            </div>
                            <span class="font-small ml-5 text-muted">(6)</span>
                            </div>
                            <div>
                            ...
                            <div class="product-price">
                                <span>1,976,896₫</span>
                                <span class="old-price">2,784,360₫</span>
                            </div>
                            <div class="add-cart">
                                <a aria-label="Add To Cart" class="action-btn add-to-cart-button add" data-id="7" data-url="https://nest.botble.com/cart/add-to-cart" href="#">
                                <i class="fi-rs-shopping-cart mr-5"></i> <span class="d-inline-block">Add</span>
                                </a>
                            </div>
                            </div>
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4 col-12 col-sm-6">
                    <div class="product-cart-wrap mb-30">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                            <a href="products/angies-boomchickapop-sweet-salty-kettle-corn.html">
                            <img class="default-img" src="<?php echo e(asset('images/products/3-400x400.jpg')); ?>" alt="Angie’s Boomchickapop Sweet &amp; Salty Kettle Corn">
                            <img class="hover-img" src="<?php echo e(asset('images/products/3-1-400x400.jpg')); ?>" alt="Angie’s Boomchickapop Sweet &amp; Salty Kettle Corn">
                            </a>
                            </div>
                        ...
                        <div class="product-content-wrap">
                            <div class="product-category">
                            <a href="product-categories/wines-drinks.html">Wines &amp; Drinks</a>
                            </div>
                            <h2><a href="products/angies-boomchickapop-sweet-salty-kettle-corn.html">Angie’s Boomchickapop Sweet &amp; Salty Kettle Corn</a></h2>
                            <div class="product-rate-cover">
                            <div class="product-rate d-inline-block">
                            ...
                            <div class="product-price">
                                <span>2,346,983₫</span>
                                <span class="old-price">6,705,667₫</span>
                            </div>
                            <div class="add-cart">
                                <a aria-label="Add To Cart" class="action-btn add-to-cart-button add" data-id="3" data-url="https://nest.botble.com/cart/add-to-cart" href="#">
                                <i class="fi-rs-shopping-cart mr-5"></i> <span class="d-inline-block">Add</span>
                                </a>
                            </div>
                            </div>
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4 col-12 col-sm-6">
                    <div class="product-cart-wrap mb-30">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                            <a href="products/foster-farms-takeout-crispy-classic-buffalo-wings.html">
                            <img class="default-img" src="<?php echo e(asset('images/products/16-400x400.jpg')); ?>" alt="Foster Farms Takeout Crispy Classic Buffalo Wings">
                            <img class="hover-img" src="<?php echo e(asset('images/products/16-1-400x400.jpg')); ?>" alt="Foster Farms Takeout Crispy Classic Buffalo Wings">
                            </a>
                            </div>
                        ...
                        <div class="product-content-wrap">
                            ...
                            <h2><a href="products/foster-farms-takeout-crispy-classic-buffalo-wings.html">Foster Farms Takeout Crispy Classic Buffalo Wings</a></h2>
                            <div class="product-rate-cover">
                            <div class="product-rate d-inline-block">
                                <div class="product-rating" style="width: 66.666666666667%"></div>
                            </div>
                            ...
                            <div class="product-price">
                                <span>1,836,258₫</span>
                                <span class="old-price">2,645,142₫</span>
                            </div>
                            <div class="add-cart">
                                <a aria-label="Add To Cart" class="action-btn add-to-cart-button add" data-id="16" data-url="https://nest.botble.com/cart/add-to-cart" href="#">
                                <i class="fi-rs-shopping-cart mr-5"></i> <span class="d-inline-block">Add</span>
                                </a>
                            </div>
                            </div>
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-4 col-12 col-sm-6">
                    <div class="product-cart-wrap mb-30">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                            <a href="products/all-natural-italian-style-chicken-meatballs.html">
                            <img class="default-img" src="<?php echo e(asset('images/products/18-400x400.jpg')); ?>" alt="All Natural Italian-Style Chicken Meatballs">
                            <img class="hover-img" src="<?php echo e(asset('images/products/18-1-400x400.jpg')); ?>" alt="All Natural Italian-Style Chicken Meatballs">
                            </a>
                            </div>
                        ...
                        <div class="product-content-wrap">
                            <div class="product-category">
                            <a href="product-categories/fresh-fruit.html">Fresh Fruit</a>
                            </div>
                            <h2><a href="products/all-natural-italian-style-chicken-meatballs.html">All Natural Italian-Style Chicken Meatballs</a></h2>
                            <div class="product-rate-cover">
                            <div class="product-rate d-inline-block">
                            ...
                            <div class="product-price">
                                <span>2,514,277₫</span>
                                <span class="old-price">2,993,187₫</span>
                            </div>
                            <div class="add-cart">
                                <a aria-label="Add To Cart" class="action-btn add-to-cart-button add" data-id="18" data-url="https://nest.botble.com/cart/add-to-cart" href="#">
                                <i class="fi-rs-shopping-cart mr-5"></i> <span class="d-inline-block">Add</span>
                                </a>
                            </div>
                            </div>
                ...
                <div class="col-xxl-3 col-xl-4 col-lg col-md-6">
                    <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <div class="product-img-action-wrap">
                            ...
                            <img src="<?php echo e(asset('images/flash-sales/3.png')); ?>" alt="Organic Frozen Triple Berry Blend" />
                            </a>
                            </div>
                        </div>
                        <div class="product-content-wrap">
                ...
                <div class="col-xxl-3 col-xl-4 col-lg col-md-6">
                    <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <div class="product-img-action-wrap">
                            ...
                            <img src="<?php echo e(asset('images/flash-sales/4.png')); ?>" alt="Simply Lemonade with Raspberry Juice" />
                            </a>
                            </div>
                        </div>
                        <div class="product-content-wrap">
                ...
                <div class="col-xxl-3 col-xl-4 col-lg col-md-6">
                    <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <div class="product-img-action-wrap">
                            ...
                            <img src="<?php echo e(asset('images/flash-sales/5.png')); ?>" alt="Signature Wood-Fired Mushroom and Caramelized" />
                            </a>
                            </div>
                        </div>
                        <div class="product-content-wrap">
...
<?php echo $__env->make('site.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/joshith/Workspace/Trivizion/Outsourcing/invesment/resources/views/welcome.blade.php ENDPATH**/ ?>