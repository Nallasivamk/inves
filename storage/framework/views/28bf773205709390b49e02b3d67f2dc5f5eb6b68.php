...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
	...
	<li class="nav-item <?php echo e(App\Http\Helper\Admin\Helpers::handleSiderActive('product')); ?>">
		<a href="<?php echo e(url('admin/manage-product/product')); ?>"><i class="menu-livicon" data-icon="list"></i><span class="menu-title" data-i18n="Email">Product</span></a>
	</li>

	<li class="navigation-header"><span>Manage Orders</span></li>
	<li class="nav-item <?php echo e(App\Http\Helper\Admin\Helpers::handleSiderActive('order')); ?>">
		<a href="<?php echo e(url('admin/manage-order/order')); ?>"><i class="menu-livicon" data-icon="servers"></i><span class="menu-title" data-i18n="Email">Order</span></a>
	</li>
  ...
  <!-- END: Main Menu--><?php /**PATH /var/www/html/laravel/invesment/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>