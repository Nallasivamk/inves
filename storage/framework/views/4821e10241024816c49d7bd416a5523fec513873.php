		  ...
		  <div class="row match-height">
			<div class="col-12">
			  <div class="card">
				...
				<?php echo Form::model($staticPageInfo,['url' => url('admin/manage-staticPage/page/update'),'id'=>'addPage','enctype' => 'multipart/form-data']); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.main.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Trivizion\Outsourcing\invesment\resources\views/admin/site/page/edit.blade.php ENDPATH**/ ?>