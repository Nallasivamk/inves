<div class="header-middle header-middle-ptb-1 d-none d-lg-block">
             ...
             <div class="header-action-right">
                <div class="header-action-2"> 
                   ...
                   <div class="header-action-icon-2">
                      ...
                      <a href="javascript:void(0)"><span class="lable ml-0"><?php echo e(Auth::user()->name); ?></span></a>
                      <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                        <ul>
                            
                            <li><a href="<?php echo e(url('logout')); ?>"><i class="fi fi-rs-user-add mr-10"></i>Logout</a></li>
                        </ul>
                      </div>
                   </div>
                   <?php else: ?>
 ...
 </div><?php /**PATH /var/www/html/laravel/invesment/resources/views/site/layouts/header.blade.php ENDPATH**/ ?>