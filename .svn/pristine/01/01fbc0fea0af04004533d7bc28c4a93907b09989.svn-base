						...
						<div class="card-content">
							...
							<section id="accordion-icon-wrapper">
							   <div class="accordion collapse-icon accordion-icon-rotate" id="accordionWrapa2">
								...
								<div class="col-lg-12">
								   <a href="{{ url('admin/manage-staticPage/page/create') }}" class="text-right"><i class='bx bx-plus-circle size bx-fade' ></i>New Page</a>
								</div>
...
$(function(){
   	...
   	var table = $('#staticPageTable').DataTable({
   		...
   		pageLength: 50,
   		ajax:{
   			url: "{{ url('admin/manage-staticPage/indexData') }}",
   			data: function (d) {
                   d.test = 'testse'
               }
   		},
